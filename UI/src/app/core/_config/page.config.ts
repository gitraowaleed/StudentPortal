export class PageConfig {
	public defaults: any = {
		Calendar: {
			page: { title: 'PAGES.CALENDAR.TITLE', desc: 'PAGES.CALENDAR.DESC' }
		},
		studentportal: {
			students: {
				page: { title: 'Students', desc: 'All Students Data' }
			},
			teachers: {
				page: { title: 'Teachers', desc: 'All Teachers Data' }
			},
			courses: {
				page: { title: 'Courses', desc: 'All Courses Data' }
			}
		},
		Profile: {
			Overview: {
				page: { title: 'PROFILE.TITLE', desc: 'PROFILE.OVERVIEW.TITLE' }
			},
			ChangePassword: {
				page: { title: 'PROFILE.TITLE', desc: 'PROFILE.CHANGEPASSWORD.TITLE' }
			}
		},
		dashboard: {
			page: {
